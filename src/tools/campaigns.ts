...
export function registerCampaignTools(
  ...
  server.tool(
    ...
    ListCampaignsSchema,
    { title: 'List campaigns', readOnlyHint: true, destructiveHint: false, openWorldHint: false },
    async (params) => {
  ...
  server.tool(
    ...
    GetCampaignSchema,
    { title: 'Get campaign details', readOnlyHint: true, destructiveHint: false, openWorldHint: false },
    async (params) => {
  ...
  server.tool(
    ...
    GetCampaignInsightsSchema,
    { title: 'Get campaign AI insights', readOnlyHint: true, destructiveHint: false, openWorldHint: false },
    async (params) => {
