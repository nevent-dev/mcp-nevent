...
export function registerTemplateTools(
  ...
  server.tool(
    ...
    ListTemplatesSchema,
    { title: 'List email templates', readOnlyHint: true, destructiveHint: false, openWorldHint: false },
    async (params) => {
  ...
  server.tool(
    ...
    GetTemplateSchema,
    { title: 'Get email template', readOnlyHint: true, destructiveHint: false, openWorldHint: false },
    async (params) => {
  ...
  server.tool(
    ...
    CreateTemplateSchema,
    { title: 'Create email template', readOnlyHint: false, destructiveHint: false, openWorldHint: false },
    async (params) => {
  ...
  server.tool(
    ...
    UpdateTemplateSchema,
    { title: 'Update email template', readOnlyHint: false, destructiveHint: true, openWorldHint: false },
    async (params) => {
  ...
  server.tool(
    ...
    CloneTemplateSchema,
    { title: 'Clone email template', readOnlyHint: false, destructiveHint: false, openWorldHint: false },
    async (params) => {
  ...
  server.tool(
    ...
    RenameTemplateSchema,
    { title: 'Rename email template', readOnlyHint: false, destructiveHint: true, openWorldHint: false },
    async (params) => {
  ...
  server.tool(
    ...
    PreviewTemplateSchema,
    { title: 'Preview template rendering', readOnlyHint: true, destructiveHint: false, openWorldHint: false },
    async (params) => {
