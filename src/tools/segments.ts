...
export function registerSegmentTools(
  ...
  server.tool(
    ...
    ListSegmentsSchema,
    { title: 'List segments', readOnlyHint: true, destructiveHint: false, openWorldHint: false },
    async (_params) => {
  ...
  server.tool(
    ...
    GetSegmentSchema,
    { title: 'Get segment details', readOnlyHint: true, destructiveHint: false, openWorldHint: false },
    async (params) => {
  ...
  server.tool(
    ...
    UpdateSegmentSchema,
    { title: 'Update segment', readOnlyHint: false, destructiveHint: true, openWorldHint: false },
    async (params) => {
